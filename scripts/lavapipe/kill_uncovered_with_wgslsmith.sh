...
DAWN=$BASE/dawn
OUTPUT=$BASE/dredd-webgpu-testing/llvmpipe/output/uncovered_by_cts
CTS=$BASE/webgpu_cts
...
TARGET_MUTANT_FILE=$BASE/dredd-webgpu-testing/llvmpipe/output/wgslsmith_mutant_targets.txt
